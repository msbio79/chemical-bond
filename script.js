...
const ATOM_DEF = {
    'H':  { name: '수소',    radius: 30, maxBonds: 1, color: '#ffffff', textColor: '#000000', mass: 1, ion: 'H<sup>+</sup>' },
    'He': { name: '헬륨',    radius: 28, maxBonds: 0, color: '#d1d8e0', textColor: '#000000', mass: 4, ion: 'He' },
    'Li': { name: '리튬',    radius: 55, maxBonds: 1, color: '#cc8e35', textColor: '#ffffff', mass: 7, ion: 'Li<sup>+</sup>' },
    'Be': { name: '베릴륨',  radius: 48, maxBonds: 2, color: '#c2cfd6', textColor: '#000000', mass: 9, ion: 'Be<sup>2+</sup>' },
    'B':  { name: '붕소',    radius: 45, maxBonds: 3, color: '#ffb8b8', textColor: '#000000', mass: 11, ion: 'B<sup>3+</sup>' },
    'C':  { name: '탄소',    radius: 50, maxBonds: 4, color: '#2f3542', textColor: '#ffffff', mass: 12, ion: 'C' },
    'N':  { name: '질소',    radius: 47, maxBonds: 3, color: '#1e90ff', textColor: '#ffffff', mass: 14, ion: 'N<sup>3-</sup>' },
    'O':  { name: '산소',    radius: 44, maxBonds: 2, color: '#ff4757', textColor: '#ffffff', mass: 16, ion: 'O<sup>2-</sup>' },
    'F':  { name: '플루오린', radius: 41, maxBonds: 1, color: '#9be010', textColor: '#000000', mass: 19, ion: 'F<sup>-</sup>' },
    'Ne': { name: '네온',    radius: 38, maxBonds: 0, color: '#b33939', textColor: '#ffffff', mass: 20, ion: 'Ne' },
    'Na': { name: '나트륨',  radius: 60, maxBonds: 1, color: '#ab87ed', textColor: '#ffffff', mass: 23, ion: 'Na<sup>+</sup>' },
    'Mg': { name: '마그네슘', radius: 55, maxBonds: 2, color: '#8ee53f', textColor: '#000000', mass: 24, ion: 'Mg<sup>2+</sup>' },
    'Al': { name: '알루미늄', radius: 50, maxBonds: 3, color: '#bfa6a6', textColor: '#000000', mass: 27, ion: 'Al<sup>3+</sup>' },
    'Si': { name: '규소',    radius: 58, maxBonds: 4, color: '#f0c330', textColor: '#000000', mass: 28, ion: 'Si' },
    'P':  { name: '인',      radius: 56, maxBonds: 3, color: '#ff9f43', textColor: '#000000', mass: 31, ion: 'P<sup>3-</sup>' },
    'S':  { name: '황',      radius: 54, maxBonds: 2, color: '#feca57', textColor: '#000000', mass: 32, ion: 'S<sup>2-</sup>' },
    'Cl': { name: '염소',    radius: 52, maxBonds: 1, color: '#1dd1a1', textColor: '#000000', mass: 35, ion: 'Cl<sup>-</sup>' },
    'Ar': { name: '아르곤',  radius: 50, maxBonds: 0, color: '#808e9b', textColor: '#ffffff', mass: 40, ion: 'Ar' },
    'K':  { name: '칼륨',    radius: 65, maxBonds: 1, color: '#8c7ae6', textColor: '#ffffff', mass: 39, ion: 'K<sup>+</sup>' },
    'Ca': { name: '칼슘',    radius: 60, maxBonds: 2, color: '#3dc1d3', textColor: '#000000', mass: 40, ion: 'Ca<sup>2+</sup>' }
};
